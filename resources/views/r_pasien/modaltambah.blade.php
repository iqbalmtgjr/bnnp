...
<div class="modal fade" id="tambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="/riwayatpasien/tambah" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
  <div class="modal-body center">
  
  
    {{-- <input type="hidden" class="form-control" id="url_getdata" name="url_getdata" value="{{url('getriwayatpasien/')}}" readonly>  --}}
    <input type="hidden" id="id_riwayat_pasien" name="id_riwayat_pasien" value="">
    {{-- <input type="hidden" id="id_pasien" name="id_pasien" value=""> --}}
      ...
      <div class="form-group row">
          <label for="" class="col-sm-5 col-form-label">Tanggal Perawatan</label>
              <div class="col-sm-11">
                  <input type="date" class="form-control" id="Tanggal_perawatan" name="Tanggal_perawatan" value="">
              </div>
      ...
      <div class="form-group row">
          <label for="" class="col-sm-5 col-form-label">Tingkat Kecanduan</label>
              <div class="col-sm-11">
                <select name="Tingkat_kecanduan" id="Tingkat_kecanduan" class="form-control">
    ...
    <div class="form-group row">
        <label for="" class="col-sm-5 col-form-label">Perawatan Ke</label>
            <div class="col-sm-11">
               <input class="form-control" name="perawatan_ke" id="perawatan_ke" type="number" placeholder="Masukkan Perawatan Ke ...">
            </div>
                <div class="invalid-feedback errorDokter"></div>
    </div>
    ...
    <div class="form-group row">
        <label for="" class="col-sm-5 col-form-label">Status Perawatan</label>
            <div class="col-sm-11">
                <select name="status_perawatan" id="status_perawatan" class="form-control">
    ...
    <div class="form-group row">
        <label for="" class="col-sm-5 col-form-label">Dokumen Perawatan</label>
            <div class="col-sm-11">
                <input type="file" id="dokumen_perawatan" name="dokumen_perawatan" value="" class="form-control">
            </div>
    </div>
    ...
    function getdata(id)
        {
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    $('#id_riwayat_pasien').val(id);
                    $('#id_pasien').val(response.id_pasien);
                    $('#Nama').val(response.datapasien.Nama);
                    $('#Tanggal_perawatan').val(response.Tanggal_perawatan);
                    $('#Tingkat_kecanduan').val(response.Tingkat_kecanduan);
                    $('#perawatan_ke').val(response.perawatan_ke);
                    $('#status_perawatan').val(response.status_perawatan);
